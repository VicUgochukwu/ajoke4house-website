...
const STRINGS = {
  en: {
    ...
    pillars: [
      ...
      { t: "In Action", d: "Roads, drainage, water, jobs — taken to the Assembly, not just talked about.", icon: "zap" },
    ],
    ...
    prio: { eyebrow: "Her Priorities", title: "Priorities for Ikorodu II.",
      items: [
        { t: "Roads & drainage", d: "Passable roads. Drains that don't flood.", icon: "route" },
        { t: "Youth jobs & skills", d: "Real skills, apprenticeships and jobs.", icon: "briefcase" },
        { t: "Water & basic services", d: "Water that runs. Services that work.", icon: "droplet" },
        { t: "Health & schools", d: "Closer clinics. Better classrooms.", icon: "heart-pulse" },
        { t: "Markets & transport", d: "Backing traders, artisans and commuters.", icon: "store" },
        { t: "Accountable representation", d: "Present, and answerable to you.", icon: "scale" },
      ] },
